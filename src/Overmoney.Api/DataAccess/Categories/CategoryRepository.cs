...
public interface ICategoryRepository : IRepository
{
    ...
    Task<Category> CreateAsync(CreateCategory category, CancellationToken cancellationToken);
...
{
    private static readonly List<Category> _connection = [new(1, 1, "Test Category")];

    public async Task<Category> CreateAsync(CreateCategory category, CancellationToken cancellationToken)
    {
